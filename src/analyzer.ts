...
import type { GuestyGuest, GuestyReservation, WowOpportunity } from "./types.js";
import { WowOpportunitySchema } from "./types.js";
...
export async function analyzeForWowOpportunity(
  message: string,
  guest: GuestyGuest | undefined,
  reservation: GuestyReservation | undefined,
): Promise<WowOpportunity> {
...
`.trim();
  ...
  return WowOpportunitySchema.parse(toolUse.input);
}
