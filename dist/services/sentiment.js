...
const log = (0, logger_js_1.createLogger)("sentiment");
...
async function analyzeSentiment(guestName, guestMessages, messageCount, checkIn, checkOut, totalPrice) {
    const now = new Date();
    ...
    let urgency = (urgencyMatch?.[1]?.toLowerCase() ?? "low");
